...
<span class="line"><span style="color:#A6ACCD;"># push一下代码</span></span></code></pre></div><p><img src="`+l+`" alt="image-20221108164141451"></p><h3 id="撤回commit" tabindex="-1">撤回commit <a class="header-anchor" href="#撤回commit" aria-label="Permalink to &quot;撤回commit&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># 保留修改的代码</span></span>
...
<span class="line"><span style="color:#A6ACCD;">git push -f</span></span></code></pre></div><h2 id="分支命名" tabindex="-1">分支命名 <a class="header-anchor" href="#分支命名" aria-label="Permalink to &quot;分支命名&quot;">​</a></h2><p>功能分支的名字，可以采用feature-*的形式命名。<br> 比如 feature-员工管理开发</p><h2 id="tag" tabindex="-1">tag <a class="header-anchor" href="#tag" aria-label="Permalink to &quot;tag&quot;">​</a></h2><p>根据tag号获取指定tag</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">git clone --branch [tags标签] [git地址]</span></span>
...
<span class="line"><span style="color:#A6ACCD;">https://github.com/kartoza/fbf-project/compare</span></span></code></pre></div>`,51),o=[t];function i(c,r,C,g,h,A){return a(),n("div",null,o)}const u=s(p,[["render",i]]);export{m as __pageData,u as default};
